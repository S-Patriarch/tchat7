...
//------------------------------------------------------------------------------
// структура, направленная на работу с классом ptl::pLogger
//
struct Logger
{
    bool        s_isWriteLogger{false}; // флаг возможности отписывать log-файл
    std::string s_strLogger{""};        // строка записи в log-файл
};
} // namespace chat
